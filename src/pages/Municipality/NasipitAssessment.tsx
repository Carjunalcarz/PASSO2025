...
const NasipitAssessment = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Nasipit'));
    }, [dispatch]);

    const fetchAssessments = async (): Promise<Assessment[]> => {
        const response = await axios.get(`${import.meta.env.VITE_API_URL_FASTAPI}/get-general-revision?municipality=nasipit&skip=0&limit=300000`, {
            headers: {
        ...
        <div>
            <ul className="flex space-x-2 rtl:space-x-reverse mb-5">
                ...
                <li className="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                    <span>Nasipit Assessment Data-2025</span>
                </li>
            </ul>
                ...
                <div className="panel bg-gradient-to-r from-blue-500 to-blue-600 text-white p-4 rounded-lg shadow-md">
                    <div className="flex justify-between items-start w-full">
                        ...
                        <div className="flex flex-col items-start gap-2">
                            <img src="/mun_logo/nasipit.png" alt="Nasipit Logo" className="w-20 h-20 rounded-sm" />
                        </div>
                    ...
                    <h1 className="text-left text-xl m-2">Nasipit</h1>
                </div>
...
export default NasipitAssessment;