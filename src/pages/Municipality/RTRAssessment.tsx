...
const RTRAssessment = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('REMEDIOS T. ROMUALDEZ'));
    }, [dispatch]);

    const fetchAssessments = async (): Promise<Assessment[]> => {
        const response = await axios.get(`${import.meta.env.VITE_API_URL_FASTAPI}/property-assessments?municipality=REMEDIOS T. ROMUALDEZ&skip=0&limit=300000`, {
            headers: {
    ...
    const { data: rowData = [], isLoading: queryLoading, refetch } = useQuery<Assessment[]>({
        queryKey: ['assessments', 'remedios_t_romualdez'],
    ...
    return (
        <div className="panel md:w-[920px] xl:w-full">
            <div className="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                <h5 className="font-semibold text-lg dark:text-white-light">REMEDIOS T. ROMUALDEZ Assessment Data-2025</h5>
