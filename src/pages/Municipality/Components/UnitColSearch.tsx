...
const sampleData = [
    ...
    {key: 'SMV Code' , value : 'smv_code' },
    {key: 'SMV Name' , value : 'smv_name' },
    {key: 'SMV Year' , value : 'smv_year' },
    {key: 'Unit Cost' , value : 'unit_cost' },
...
function UnitColSearchWithSuggestions({ setSearchColumn }: { setSearchColumn: (value: string) => void }) {
...
export default UnitColSearchWithSuggestions;