...
const BuenavistaAssessment = () => {
    ...
    const cols: Column[] = [
        ...
        { accessor: 'gr', title: 'Transaciotn Code', sortable: true },
    ...
    const fetchAssessments = async (): Promise<Assessment[]> => {
        const response = await axios.get(`${import.meta.env.VITE_API_URL_FASTAPI}/property-assessments?municipality=buenavista&skip=0&limit=300000`, {
            headers: {
