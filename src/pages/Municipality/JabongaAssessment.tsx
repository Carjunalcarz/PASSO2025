...
const JabongaAssessment = () => {
    ...
    const fetchAssessments = async (): Promise<Assessment[]> => {
        try {
            ...
            console.error('❌ JabongaAssessment: Error fetching assessments:', error);
            throw error;
        }
    };
    ...
    >({
        mutationFn: async (municipalityName: string) => {
            try {
                console.log('🔄 JabongaAssessment: Bulk deleting assessments for municipality:', municipalityName);
                ...
                console.log('✅ JabongaAssessment: Bulk delete completed:', result);
                return result;
            } catch (error) {
                console.error('❌ JabongaAssessment: Error bulk deleting assessments:', error);
                throw error;
            }
        },
        onSuccess: (result) => {
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="form-group">
                            ...
                            <input
                                ...
                                placeholder="Enter municipality name (e.g., Jabonga)"
