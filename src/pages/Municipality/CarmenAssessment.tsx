...
const CarmenAssessment = () => {
    ...
    const fetchAssessments = async (): Promise<Assessment[]> => {
        try {
            ...
            return carmenAssessments;
        } catch (error) {
            console.error('❌ CarmenAssessment: Error fetching assessments:', error);
            throw error;
        }
    };
    ...
    const createMutation = useMutation<Assessment, Error, Partial<Assessment>>({
        mutationFn: async (newData) => {
            try {
                console.log('🔄 CarmenAssessment: Creating new assessment...');
                const result = await databaseService.createAssessment(
                    PROPERTY_ASSESSMENTS_COLLECTION_ID,
                    newData as Omit<AssessmentDocument, '$id' | '$createdAt' | '$updatedAt'>
                );
                console.log('✅ CarmenAssessment: Assessment created successfully');
                return result;
            } catch (error) {
                console.error('❌ CarmenAssessment: Error creating assessment:', error);
                throw error;
            }
        },
        onSuccess: () => {
    ...
    >({
        mutationFn: async (data: Assessment) => {
            try {
                console.log('🔄 CarmenAssessment: Updating assessment:', data.$id);
                if (!data.$id) {
                ...
                console.log('✅ CarmenAssessment: Assessment updated successfully');
                return result;
            } catch (error) {
                console.error('❌ CarmenAssessment: Error updating assessment:', error);
                throw error;
            }
        },
        onSuccess: () => {
    ...
    >({
        mutationFn: async (tdn: string) => {
            try {
                console.log('🔄 CarmenAssessment: Deleting assessment with TDN:', tdn);
                ...
                console.log('✅ CarmenAssessment: Assessment deleted successfully');
            } catch (error) {
                console.error('❌ CarmenAssessment: Error deleting assessment:', error);
                throw error;
            }
        },
        onSuccess: () => {
    ...
    >({
        mutationFn: async (municipalityName: string) => {
            try {
                console.log('🔄 CarmenAssessment: Bulk deleting assessments for municipality:', municipalityName);
                ...
                console.log('✅ CarmenAssessment: Bulk delete completed:', result);
                return result;
            } catch (error) {
                console.error('❌ CarmenAssessment: Error bulk deleting assessments:', error);
                throw error;
            }
        },
        onSuccess: (result) => {
        ...
        <div>
            <ul className="flex space-x-2 rtl:space-x-reverse mb-5">
                ...
                <li className="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                    <span>Carmen Assessment Data-2025</span>
                </li>
            </ul>
             ...
             <div className="overflow-x-auto scrollbar-hidden scrollbar-hover">
                <div className="grid grid-flow-col auto-cols-[minmax(250px,1fr)] gap-4 mb-6 w-max min-w-full">
                    ...
                    <div className="panel bg-gradient-to-r from-blue-500 to-blue-600 text-white p-4 rounded-lg shadow-md">
                        ...
                        <p className="text-left text-xl m-2">Carmen</p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="form-group">
                            ...
                            <input
                                ...
                                placeholder="Enter municipality name (e.g., Carmen)"
