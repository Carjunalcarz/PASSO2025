...
const SantiagoAssessment = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Santiago'));
    }, [dispatch]);
    ...
    >({
        mutationFn: async (municipalityName: string) => {
            try {
                console.log('🔄 SantiagoAssessment: Bulk deleting assessments for municipality:', municipalityName);
                ...
                console.log('✅ SantiagoAssessment: Bulk delete completed:', result);
                return result;
            } catch (error) {
                console.error('❌ SantiagoAssessment: Error bulk deleting assessments:', error);
                throw error;
            }
        },
        onSuccess: (result) => {
        ...
        <div>
            <ul className="flex space-x-2 rtl:space-x-reverse mb-5">
                ...
                <li className="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                    <span>Santiago Assessment Data-2025</span>
                </li>
            </ul>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="form-group">
                            ...
                            <input
                                ...
                                placeholder="Enter municipality name (e.g., Santiago)"
...
export default SantiagoAssessment;