...
const TubayAssessment = () => {
    ...
    >({
        mutationFn: async (municipalityName: string) => {
            try {
                console.log('🔄 TubayAssessment: Bulk deleting assessments for municipality:', municipalityName);
                ...
                console.log('✅ TubayAssessment: Bulk delete completed:', result);
                return result;
            } catch (error) {
                console.error('❌ TubayAssessment: Error bulk deleting assessments:', error);
                throw error;
            }
        },
        onSuccess: (result) => {
            ...
            <div className="overflow-x-auto scrollbar-hidden scrollbar-hover">
                <div className="grid grid-flow-col auto-cols-[minmax(250px,1fr)] gap-4 mb-6 w-max min-w-full">
                    ...
                    <div className="panel bg-gradient-to-r from-blue-500 to-blue-600 text-white p-4 rounded-lg shadow-md">
                        ...
                        <p className="text-left text-xl m-2">Tubay</p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="form-group">
                            ...
                            <input
                                ...
                                placeholder="Enter municipality name (e.g., Tubay)"
