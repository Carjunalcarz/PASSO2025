...
const KitcharaoAssessment = () => {
    ...
    const filteredData = searchFilteredData.filter((item: Assessment) => {
        ...
        const matchesGR = 
            grFilter === 'all' || item.gr_code?.toLowerCase() === grFilter.toLocaleLowerCase();
    ...
    >({
        mutationFn: async (municipalityName: string) => {
            try {
                console.log('🔄 KitcharaoAssessment: Bulk deleting assessments for municipality:', municipalityName);
                ...
                console.log('✅ KitcharaoAssessment: Bulk delete completed:', result);
                return result;
            } catch (error) {
                console.error('❌ KitcharaoAssessment: Error bulk deleting assessments:', error);
                throw error;
            }
        },
        onSuccess: (result) => {
        ...
        <div>
            <ul className="flex space-x-2 rtl:space-x-reverse mb-5">
                ...
                <li className="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                    <span>Kitcharao Assessment Data-2025</span>
                </li>
            </ul>
                    ...
                    <div className="panel bg-gradient-to-r from-blue-500 to-blue-600 text-white p-4 rounded-lg shadow-md">
                        <div className="flex justify-between items-start w-full">
                            <div className="flex flex-col items-start gap-2">
                                <img src="/mun_logo/kitcharao.png" alt="kitcharao Logo" className="w-20 h-20 rounded-sm" />
                            </div>
                        ...
                        <p className="text-left text-xl m-2">Kitcharao</p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="form-group">
                            ...
                            <input
                                ...
                                placeholder="Enter municipality name (e.g., Kitcharao)"
