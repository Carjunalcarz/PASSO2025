...
const SubClassifications = () => {
    ...
    const handleView = (record: SubClassificationData) => {
        ...
        Swal.fire({
            title: `<strong style="color: ${isDark ? '#60a5fa' : '#4361ee'};">Sub-Classification Details</strong>`,
            html: `
          ...
          <table style="width: 100%; border-collapse: separate; border-spacing: 0; border: 1px solid ${borderColor}; border-radius: 8px; overflow: hidden;">
            <tbody>
              ...
              <tr style="background: ${bgSecondary};">
                ...
                <td style="padding: 14px 16px; color: ${valueColor}; border-bottom: 1px solid ${borderColor}; font-weight: 500;">${getClassificationName(record.classification_id)}</td>
              </tr>
              <tr style="background: ${bgPrimary};">
                <td style="padding: 14px 16px; font-weight: 600; color: ${labelColor}; border-bottom: 1px solid ${borderColor};">
                  <span style="display: flex; align-items: center;">
