...
const Products = () => {
    ...
    const handleView = (record: ProductData) => {
        ...
        Swal.fire({
            title: `<span style="color: ${isDark ? '#60a5fa' : '#1e40af'}; font-size: 22px; font-weight: 700;">Product Details</span>`,
            html: `
          ...
          <table style="width: 100%; border-collapse: separate; border-spacing: 0; border: 1px solid ${borderColor}; border-radius: 12px; overflow: hidden;">
            <tbody>
              <tr style="background: ${bgPrimary};">
                <td style="padding: 14px 16px; font-weight: 600; color: ${labelColor}; width: 35%; border-bottom: 1px solid ${borderColor};">
                ...
                <td style="padding: 14px 16px; color: ${valueColor}; font-weight: 500; border-bottom: 1px solid ${borderColor};">${record.name}</td>
              </tr>
              <tr style="background: ${bgSecondary};">
                ...
                <td style="padding: 14px 16px; color: ${secondaryTextColor}; border-bottom: 1px solid ${borderColor};">${record.description || '-'}</td>
              </tr>
              <tr style="background: ${bgPrimary};">
                <td style="padding: 14px 16px; font-weight: 600; color: ${labelColor}; border-bottom: 1px solid ${borderColor};">
                  <span style="display: flex; align-items: center;">
